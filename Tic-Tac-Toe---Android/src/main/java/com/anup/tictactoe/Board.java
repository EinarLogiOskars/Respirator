/*
 * This code is borrowed from github, Author is Anup Agarwal
 */
...
public class Board extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.activity_board, container, false);
        b = getArguments();
        resid = b.getInt("resid");

        size = Integer.parseInt(getString(R.string.size_of_board));
        board = new char [size][size];
        mainBoard = (TableLayout) v.findViewById(R.id.mainBoard);
        tv_turn = (TextView) v.findViewById(R.id.turn);
        ...
        Button rstbtn = (Button) v.findViewById(R.id.reset);
        rstbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                resetBoard();
                Fragment frg = getFragmentManager().findFragmentById(resid);
            ...
            public void onClick(View v) {
                ...
                if(!Cell_Set(r,c)) {
                    ...
                    if (gameStatus() == 0) {
                        ...
                        tv_turn.setText(notYourTurn+" Wins the game!!");
                        stopMatch();
                    }
                }
                else{
